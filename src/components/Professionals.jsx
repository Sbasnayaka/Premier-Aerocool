        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-4xl font-bold text-slate-900 mb-6 font-heading leading-tight">
              Our <span className="text-blue-500">Expert</span> Professionals
            </h2>
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            {/* Background Blob */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-100 blur-3xl rounded-full opacity-50" />
          </div>
